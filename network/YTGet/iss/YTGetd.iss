...
OutputDir=output
OutputBaseFilename="{#SetupFileBaseName}-{#AppVersion}D"
...
[Files]
Source: "..\Debug\{#AppExeFullName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Debug\{#AppExeFullName}.manifest"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\log4cplus.properties"; DestDir: "{app}"; Flags: ignoreversion
