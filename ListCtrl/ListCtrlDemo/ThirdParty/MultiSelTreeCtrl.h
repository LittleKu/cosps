...
#define MST_EXPAND_PARAM_STATE_IMAGE				0x0001
#define MST_EXPAND_PARAM_ITEM_EXCLUDE				0x0002

#define MST_EXPAND_SUB_PARAM_STATE_UNCHECK			0x0001
#define MST_EXPAND_SUB_PARAM_STATE_PARTIAL_CHECK	0x0002
#define MST_EXPAND_SUB_PARAM_STATE_FULL_CHECK		0x0004
...
public:
	...
	void ExpandAllItems(HTREEITEM hTreeItemRoot, UINT nCode, HTREEITEM hItemExclude = NULL, UINT nStateImage = 0);
