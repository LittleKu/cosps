// CDListCtrlDlg.cpp : implementation file
//

#include "stdafx.h"
#include "CDListCtrl.h"
#include "CDListCtrlDlg.h"
...
CCDListCtrlDlg::CCDListCtrlDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CCDListCtrlDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CCDListCtrlDlg)
...
void CCDListCtrlDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCDListCtrlDlg)
	DDX_Control(pDX, IDC_LIST1, m_listCtrl);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CCDListCtrlDlg, CDialog)
	//{{AFX_MSG_MAP(CCDListCtrlDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
...
/////////////////////////////////////////////////////////////////////////////
// CCDListCtrlDlg message handlers

BOOL CCDListCtrlDlg::OnInitDialog()
{
...
void CCDListCtrlDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CCDListCtrlDlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}

void CCDListCtrlDlg::InitListCtrl()
{
