// CheckListBoxCBNDlg.cpp : implementation file
//

#include "stdafx.h"
#include "CheckListBoxCBN.h"
#include "CheckListBoxCBNDlg.h"
...
CCheckListBoxCBNDlg::CCheckListBoxCBNDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CCheckListBoxCBNDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CCheckListBoxCBNDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CCheckListBoxCBNDlg message handlers
...
void CCheckListBoxCBNDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CCheckListBoxCBNDlg::OnPaint() 
{
	if (IsIconic())
	{
...
HCURSOR CCheckListBoxCBNDlg::OnQueryDragIcon()
{
...
void CCheckListBoxCBNDlg::OnSelchangeList1() 
{
	...
	TRACE( "CCheckListBoxCBNDlg::OnSelchangeList1\n" );	
}
